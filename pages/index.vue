  ...
  data() {
    return {
      ...
      MyProcessData: {
        ...
        process: [
          {
            title: "Planing project",
            steps: [
              { text: "Define project goals" },
              { text: "Create backlogs" },
              { text: "Break down the features" },
            ],
          },
          {
...

          {
            ...
            steps: [
              {
                text: "A short daily stand-up during the sprint to reassess progress",
              },
            ],
          },
          {
            ...
            steps: [
              ...
              { text: "Reflect on areas for imporvement" },
            ],
          },
        ],
        image: {
